...
public class SingletonGestorCultravel {
    ...
    private static final String mUrlAPIPontosTuristicos = "http://amsi.dei.estg.ipleiria.pt/api/livros"; //API pontos turisticos
    private static final String mUrlAPIUtilizadores = "http://localhost:8888/"; //API pontos turisticos
